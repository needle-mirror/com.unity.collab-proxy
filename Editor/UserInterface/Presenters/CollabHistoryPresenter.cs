...
namespace UnityEditor.Collaboration
{
    internal class CollabHistoryPresenter
    {
        ...
        public CollabHistoryPresenter(ICollabHistoryWindow window, ICollabHistoryItemFactory factory,
            IRevisionsService service, BuildAccess buildAccess)
        {
            m_Window = window;
            m_Factory = factory;
            m_Service = service;
            m_CurrentPage = 0;
            m_BuildAccess = buildAccess;
        ...
        protected virtual bool IsProjectBound()
        {
