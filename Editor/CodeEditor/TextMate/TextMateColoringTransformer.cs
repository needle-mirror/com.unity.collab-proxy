...
{
    internal class TextMateColoringTransformer :
        ...
        IModelTokensChangedListener
    {
        ...
        private readonly Dictionary<int, Color> _brushes;

        internal TextMateColoringTransformer(
            TextView textView,
            ...
            : base(exceptionHandler)
        {
            ...
            _brushes = new Dictionary<int, Color>();
            _textView.VisualLinesChanged += TextView_VisualLinesChanged;
        }

        internal void SetModel(TextDocument document, TMModel model)
        {
        ...
        internal void SetTheme(Theme theme)
        {
            ...
            foreach (var color in map)
            {
                ...
                _brushes[id] = ToRGBColor(NormalizeColor(color));
            }
        }
        ...
        static Color ToRGBColor(string normalizedColor)
        {
            if (ColorUtility.TryParseHtmlString(normalizedColor, out Color color))
                return color;
