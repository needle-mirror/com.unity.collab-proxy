...
namespace Plugins.PlasticSCM.Editor.Diff.Texture
{
    internal class ImageContentControl : VisualElement
    {
        internal void ShowData(DiffViewerData data)
        {
            Clear();

            Add(BuildTitle("Image Content Control"));
            ...
            Add(BuildInfoLabel("File", data.Left.File));
            Add(BuildInfoLabel("File", data.Right.File));
