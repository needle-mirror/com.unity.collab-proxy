    ...
    internal class PlasticExeLauncher : IToolLauncher
    {
            ...
            IProcessExecutor processExecutor = null)
        {
            return new PlasticExeLauncher(
                wkInfo,
                isGluonMode,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticCloudFromDiffContributors,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticEnterpriseFromDiffContributors,
                TrackFeatureUseEvent.Features.UnityPackage.CancelPlasticInstallationFromDiffContributors,
                false,
            ...
            IProcessExecutor processExecutor = null)
        {
            return new PlasticExeLauncher(
                wkInfo,
                isGluonMode,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticCloudFromDiffWorkspaceContent,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticEnterpriseFromDiffWorkspaceContent,
                TrackFeatureUseEvent.Features.UnityPackage.CancelPlasticInstallationFromDiffWorkspaceContent,
                false,
                showDownloadPlasticExeWindow,
                checkIsExeAvailable ?? new CheckIsExeAvailable(),
                processExecutor ?? new ProcessExecutor());
            ...
            IProcessExecutor processExecutor = null)
        {
            return new PlasticExeLauncher(
                wkInfo,
                isGluonMode,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticCloudFromShowDiff,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticEnterpriseFromFromShowDiff,
                TrackFeatureUseEvent.Features.UnityPackage.CancelPlasticInstallationFromFromShowDiff,
                false,
                showDownloadPlasticExeWindow,
                checkIsExeAvailable ?? new CheckIsExeAvailable(),
                processExecutor ?? new ProcessExecutor());
            ...
            IProcessExecutor processExecutor = null)
        {
            return new PlasticExeLauncher(
                wkInfo,
                isGluonMode,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticCloudFromDiffRevision,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticEnterpriseFromDiffRevision,
                TrackFeatureUseEvent.Features.UnityPackage.CancelPlasticInstallationFromDiffRevision,
                false,
                showDownloadPlasticExeWindow,
                checkIsExeAvailable ?? new CheckIsExeAvailable(),
                processExecutor ?? new ProcessExecutor());
            ...
            IProcessExecutor processExecutor = null)
        {
            return new PlasticExeLauncher(
                wkInfo,
                    isGluonMode,
                    TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticCloudFromResolveConflicts,
                    TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticEnterpriseFromResolveConflicts,
                    TrackFeatureUseEvent.Features.UnityPackage.CancelPlasticInstallationFromResolveConflicts,
                true,
                showDownloadPlasticExeWindow,
                checkIsExeAvailable ?? new CheckIsExeAvailable(),
                processExecutor ?? new ProcessExecutor());
            ...
            IProcessExecutor processExecutor = null)
        {
            return new PlasticExeLauncher(
                wkInfo,
                isGluonMode,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticCloudFromMergeSelectedFiles,
                TrackFeatureUseEvent.Features.UnityPackage.InstallPlasticEnterpriseFromMergeSelectedFiles,
                TrackFeatureUseEvent.Features.UnityPackage.CancelPlasticInstallationFromMergeSelectedFiles,
                true,
                showDownloadPlasticExeWindow,
                checkIsExeAvailable ?? new CheckIsExeAvailable(),
                processExecutor ?? new ProcessExecutor());
