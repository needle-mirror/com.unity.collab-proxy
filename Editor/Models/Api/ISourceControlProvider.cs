...
namespace Unity.Cloud.Collaborate.Models.Api
{
    internal interface ISourceControlProvider
    {
        ...
        /// <summary>
        /// Event called when changes request starts.
        /// </summary>
        event Action StartedRequestingChanges;

        /// <summary>
        /// Event called when changes request has finished.
        /// </summary>
        event Action FinishedRequestChanges;
        ...
        /// <summary>
        /// Whether or not the provider is requesting changes.
        /// </summary>
        bool RequestingChanges { get; }

        /// <summary>
        /// Request the current change list.
        /// </summary>
        IReadOnlyList<IChangeEntry> ChangeList { get; }
