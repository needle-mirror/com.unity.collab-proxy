...
namespace Unity.Cloud.Collaborate.Tests.Models
{
    internal class TestSourceControlProvider : ISourceControlProvider
    {
        ...
        public event Action StartedRequestingChanges = delegate {  };
        public event Action FinishedRequestChanges = delegate {  };
        ...
        public bool RequestingChanges { get; set; }
        public IReadOnlyList<IChangeEntry> ChangeList { get; set; } = new List<IChangeEntry>();
