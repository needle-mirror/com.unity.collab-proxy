...
angular.module("toolbar/project/preparing/preparing.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("toolbar/project/preparing/preparing.tpl.html",
    "<div class=\"hero-panel\"><div class=\"header\"><div class=\"header-content\"><i class=\"icon-collaborate-timer\"></i><span class=\"text\">Please wait</span></div></div><div class=\"content\"><p class=\"message\">Scanning project...</p></div></div>");
}]);
...
angular.module("toolbar/project/working/working.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("toolbar/project/working/working.tpl.html",
    "<div class=\"hero-panel\"><div class=\"header\"><div class=\"header-content\"><i class=\"icon-collaborate-timer\"></i><span class=\"text\">Please wait</span></div></div><div class=\"content\"><p class=\"message\">Putting in the final touches...</p></div></div>");
}]);
